...
function Footer() {
  return (
    <div className=' h-fit mt-[10vh]  ' >
        ...
        <hr className="w-[100%]  mt-[1vh] dark:bg-gray-700  bg-gray-700"></hr>

        <div>
        <div className='font p-3 pl-[12vw] h-full bg-[#f2f2f2]'><span className='text-[#1a0dab] text-sm'>Created By Ayush Gupta For The Community</span></div>
        </div>
